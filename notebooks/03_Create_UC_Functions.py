...
# MAGIC %sql
# MAGIC -- Test super balance projection
# MAGIC SELECT 
# MAGIC   ${catalog_name}.aus.project_super_balance(285000, 43, 60, 120000, 9.5, 10.5, 7.0) as projected_balance;

# COMMAND ----------

# MAGIC %sql
# MAGIC -- Test UK state pension
# MAGIC SELECT 
# MAGIC   ${catalog_name}.uk.calculate_state_pension(22) as weekly_pension;
